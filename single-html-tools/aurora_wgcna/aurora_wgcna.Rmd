...
expression_data = read.csv(opt$expression_data, header = TRUE, row.names = 1)
...
if(!is.na(opt$height_cut)) {
  # plot a line to show the cut
  abline(h = opt$height_cut, col = "red")
...
write.csv(output, file = opt$gene_info_file, quote=FALSE, row.names=TRUE)
